    ...
    if(date1 === date2){
        ...
        success : function(r) {
                ...
                for(var i = 0; i < r.length; i++){
                    ...
                    $("#section1").append("<b>Dagens lunch:</b> ",r[i].foodName," ",r[i].price,":-"," ",r[i].todaysDate,"<br>");
                }
    ...
    $.ajax({
        ...
        success : function(r) {
                ...
                for(var i = 0; i < r.length; i++){
                    ...
                    //MONDAY
                    if (date1 === date){ 
                        $("#section2").append("<b>Dagens lunch:</b> ",r[i].foodName," ",r[i].price,":-"," ",r[i].todaysDate,"<br>");
